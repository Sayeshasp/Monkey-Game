...
function draw() {
  ...
  if (gameState === START) {
    ...
    textSize(30);
    text("PRESS SPACE TO START", 200, 385);
    ...
    //To increase the ground speed
    ground.velocityX = -(4 + score / 10);

    //To make the monkey jump to surmount obstacles
    if (keyDown("space") && monkey.y > 320) {
      //To assign upward velocity
      monkey.velocityY = -11;
      jumpSound.play();
    }

    //To make monkey long jump 
    ...
    //To detect and decrease the chances
    ...
    //To play a beep sound in multiple of 20
  ...
  if (ground.x < 0) {
    //To give infinite scrolling effect 
    ground.x = ground.width / 2;
  }

  //To make monkey collide
